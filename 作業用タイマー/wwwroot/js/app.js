...
function renderStats() {
    ...
    const availableRest = Math.max(0, earnedRest - usedRest);
    document.getElementById("totalRest").textContent = format(availableRest);
    document.getElementById("remainRest").textContent = format(availableRest);
